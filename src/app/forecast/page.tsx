...
import { fetchWeatherData } from '../api/weatheractions';
...
export default async function ForecastPage({
    ...
    if (!searchParams.city && !searchParams.zip) {
        return (
            <div className="flex flex-col items-center min-h-screen justify-center">
                <p className="mb-4">No city selected</p>
    ...
    const data = await fetchWeatherData(searchParams.city || searchParams.zip || '');

    if (!data) {
        return (
            <div className="flex flex-col items-center min-h-screen justify-center">
                <p className="text-red-400 mb-4">Error loading weather data</p>
                <Link href="/" className="text-blue-500 hover:underline">
                    Back to Search
                </Link>
            </div>
    ...
    const firstDataForEachDate = (uniqueDates as string[]).map((date: string) => {
            ...
            <main className="px-3 max-w-7xl mx-auto flex flex-col gap-9 w-full pb-10 pt-4">
                <>
                    ...
                    <section className="flex w-full flex-col gap-4">
                        ...
                        {firstDataForEachDate.map((d: WeatherDetail | undefined, i: number) => (
